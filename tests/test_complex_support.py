...
class TestComplexFEM(unittest.TestCase):
    ...
    def test_complex_perm_dtype_preservation(self):
        ...
        el_pos = np.array([1, 2])
        mesh = PyEITMesh(node=node, element=element, perm=perm_complex, el_pos=el_pos, ref_node=3)
        
        # Check mesh dtype
        self.assertEqual(mesh.dtype, np.complex128, "mesh.dtype should be complex128 for complex perm")
    ...
    def test_complex_perm_kg_assembly(self):
        ...
        mesh = PyEITMesh(node=node, element=element, perm=perm_complex, el_pos=el_pos, ref_node=2)
        fwd = pyeit.eit.fem.Forward(mesh)
        ...
        self.assertTrue(np.iscomplexobj(kg_dense), "kg matrix should contain complex values")
    ...
    def test_solve_with_complex_perm(self):
        ...
        self.assertTrue(np.iscomplexobj(f), "Potential should be complex-valued for complex perm")
    ...
    def test_solve_vectorized_with_complex_perm(self):
        ...
        self.assertEqual(f_all.shape, (2, 4), "Output shape should match (n_exc, n_nodes)")
...
class TestComplexEITForward(unittest.TestCase):
    ...
    def test_compute_jac_with_complex_perm(self):
        ...
        self.assertTrue(np.iscomplexobj(v0), "Reference voltage should be complex-valued")
...
class TestComplexJAC(unittest.TestCase):
    ...
    def test_jac_solve_gs_with_complex_voltage(self):
        ...
        self.assertEqual(ds.shape, (mesh.n_elems,), "Output shape should match n_elements")
...
class TestComplexDataIntegrity(unittest.TestCase):
    ...
    def test_real_perm_maintains_real_solution(self):
        ...
        mesh = PyEITMesh(node=node, element=element, perm=perm_real, el_pos=el_pos, ref_node=2)
        fwd = pyeit.eit.fem.Forward(mesh)
...
class TestComplexDocumentation(unittest.TestCase):
    ...
    def test_example_complex_eit_workflow(self):
        ...
        mesh = PyEITMesh(node=node, element=element, perm=perm, el_pos=el_pos, ref_node=3)
        ...
        self.assertEqual(ds.shape, (mesh.n_elems,), "Reconstruction should have correct shape")
